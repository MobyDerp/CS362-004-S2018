...
int ambassadorFunc(int currentPlayer, int choice1, int choice2, struct gameState *state, int handPos){
  int i, j;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
      adventurerFunc(currentPlayer, state, handPos);
      return 0;

    case council_room:
      councilFunc(currentPlayer, state);
      return 0;
    ...
    case ambassador:
      ambassadorFunc(currentPlayer,choice1, choice2, state,handPos);
      return 0;
